...
void parseVnstat(String interfaces){ // Usage : parseVnstat(Interfaces vnstat);
    ...
    if (err){
      ...
      vnstat.todayTotal = vnstat.todayUsageTX+vnstat.todayUsageRX;
      ...
      vnstat.monthTotal = vnstat.monthUsageTX+vnstat.monthUsageRX;
...
void parseSysinfo(){ // Usage : parseSysinfo();
    ...
    if (err){
      ...
      sysinfo.memPercent = sysinfo.memUsage/sysinfo.memTot;
